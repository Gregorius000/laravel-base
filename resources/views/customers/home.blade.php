        ...
        <div class="container">
            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12">
                    <div class="bg- shadow-sm  rounded-md w-full relative">
        ...
        <div class="container">
            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-6">
                    <div
                        class="bg-white shadow-sm  rounded-md w-full relative overflow-hidden">
                            ...
                            <div class="flex-auto  text-center">
                                ...
                                <div class="flex-auto  text-center p-4">
                                    ...
                                    <a href="ecommerce-product-detail.html"
                                        class="text-xl font-semibold text-slate-500 leading-3 block mb-2">{{ $product->name }}</a>
                                    <div class="mb-4">
            ...
            <div class="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 pt-0 md:pt-10">
                <div
                    ...
                    <div class="flex-auto p-4">
                        ...
                        <h4 class="font-semibold text-lg my-1">Fast Delivery</h4>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        ...
                        <h4 class="font-semibold text-lg my-1">Returns In 30 Days</h4>
                        <p class="text-slate-500 text-sm font-medium">
                            It is a long established fact that a reader will be distracted.
                            Contrary to popular belief.
                        </p>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        ...
                        <h4 class="font-semibold text-lg my-1">Online Support 24/7</h4>
                        <p class="text-slate-500 text-sm font-medium">
                            It is a long established fact that a reader will be distracted.
                            Contrary to popular belief.
                        </p>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        ...
                        <h4 class="font-semibold text-lg my-1">Secure Payment</h4>
                        <p class="text-slate-500 text-sm font-medium">
                            It is a long established fact that a reader will be distracted.
                            Contrary to popular belief.
                        </p>
